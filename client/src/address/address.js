...
export default function Address() {
    ...
    const getAddress = async () => {
        ...
        docSnap.forEach((doc) => {
            setUserAdrs(current => [...current, doc.data()]);
        })
    }
    ...
    const submitHandler = async (e) => {
        ...
        if (adrsFree) {
            ...
            let err = 'Sistemde kayıtlı adresiniz bulunmaktadır.';
            alert(err);
            set();
        }
    }
                ...
                <div id="vue">
                    <nav className="pageTabNavigation" aria-label="Üst Sayfalar">
                        <ul className="breadcrumbNavigation">
                            ...
                            <li><a href="#" onClick={go}>Nüfus ve Vatandaşlık İşleri Genel Müdürlüğü</a></li>
