...
export default function AdrsUpdate() {
    ...
    const go = event => {
        ...
        navigate('/services', { state: {id: id1, adrs: adrs} });
    }
                                ...
                                <fieldset className='formRowField'>
                                    <div className="formRowAddress">
                                        ...
                                        <div className="fieldGroup">
                                            <input name="tridField" ref={ref} type="text" className="text" id="tridField"
                                                tabIndex="1" onChange={cityChange}
                                                autoComplete="off"
                                    ...
                                    <div className="formRowAddress">
                                        ...
                                        <div className="fieldGroup">
                                            <input name="egpField" ref={ref1} type="text" className="text"
                                    ...
                                    <div className="formRowAddress">
                                        ...
                                        <div className="fieldGroup">
                                            <input name="egpField" ref={ref2} type="text" className="text"
