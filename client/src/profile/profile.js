         ...
         <header id="top">
             ...
             <div id="vue">
                 ...
                 <section id="pageContentBlock" className="themed">
                    <ul class="htoogleBar">
                        <li><a href="/bana-ozel">Bana Özel</a></li>
                        <li><a href="/kisisel-bilgiler" class="selected">Bilgilerim</a></li>
                        <li><a href="/sifre-guvenlik-ayarlari">Güvenlik Ayarları</a></li>
                    </ul>
                 <aside id="serviceHelperBlock">
                    <ul className="serviceIntroductionBlock">
                        <li><a href="/profile" class="selected">Kimlik Bilgilerim</a></li>
